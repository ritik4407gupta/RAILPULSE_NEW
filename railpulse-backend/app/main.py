...
from app.api.routes import alerts, auth, demo, docs, network, predictions, health, trains, simulation
...
app.include_router(demo.router, prefix=settings.API_PREFIX + "/demo", tags=["Demo Data"])
